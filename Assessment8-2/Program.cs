                    ...
                    case 1:
                        {
                            ...
                            Insert(dt, 1, "iPhone", 63000.50, new DateTime(day: 10, month: 11, year: 2021), new DateTime(day: 23, month: 11, year: 2023));
                            Insert(dt, 3, "Laptop", 73000.30, new DateTime(day: 17, month: 02, year: 2014), new DateTime(day: 11, month: 12, year: 2019));
                            Insert(dt, 5, "Smart watch", 5000.45, new DateTime(day: 07, month: 09, year: 2023), new DateTime(day: 13, month: 11, year: 2027));
                            Display(dt);
                            break;
                        }
                    case 2:
